\begin{table}[t]
  ...
  \caption{Gratings available for use with the \gls{RSS}. Table adapted from the \gls{SALT} call for proposals \citep{SALT_CFP}.}
...
\end{table}
\footnotetext{The PG0300 surface relief grating has been replaced with the PG0700 \gls{VPH} grating as of November 2022, and as such is no longer available for science observations, but has been included here as observations using the PG0300 are used in later sections.}
