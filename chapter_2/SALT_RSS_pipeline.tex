...
\begin{figure}[t]
    \centering
    \includegraphics[width = 0.9\textwidth]{2_spectrometer.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width = 7cm]{2_prism_diagram.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width = 9cm]{2_grating_diagram.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width = 10cm]{2_grism.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width = 10cm]{2_vph_grating.pdf}
