...
\begin{equation}
    I^{2} \geq  Q^{2} + U^{2} + V^{2}\,,
\end{equation}
where $I, Q, U, \text{ and } V$ are the normalized polarization parameters.
\prgph

% In general, and henceforth, $(P_{I}, P_{Q}, P_{U}, P_{V})$ are relative quantities normalized to the intensity, where
% \begin{align}
%     P_{I} & = 1\,, & P_{Q} & = \frac{Q}{I}\,, & P_{U} & = \frac{U}{I}\,, \text{   and } & P_{V} & = \frac{V}{I}\,.\label{eq:norm_Stokes}
% \end{align}
% \prgph
...
\begin{figure}[t]
    ...
    \caption{Diagram of an ideal polarimeter. Diagram adapted from \cite{pol_in_spectra}.}
