...
Along with common points of consideration when developing any instrumentation for observational astronomy, such as resolution and sensitivity, spectropolarimeters need to consider both the spectral range and any inherent polarization that may be introduced by the any elements within the light path. Time is another constraint for spectropolarimetry as, depending on the target of observation, the incident light is split up by wavelength as well as by polarization states. This `double' dividing of the incident light results in increased exposure times of not only target frames but also calibration frames which are time-dependent when compared to more traditional photometric observations.
