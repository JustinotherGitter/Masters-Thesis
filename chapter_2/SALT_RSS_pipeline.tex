...
% which returns the positions of the  x-intercepts.
...
% \noindent which is derived from \autoref{eq:poincare_coords} or by solving a system of linear equations of \autoref{eq:specpol_F_to_params} \citep{pol_std,keller_instr}.
