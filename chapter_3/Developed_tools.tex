...
\todo{Mention help docs for POLSALT, IRAF, and supplementary tools.}
\prgph
...
\todo{General reduction procedure from raw data to finalized results
    \begin{itemize}
        \item raw files from salt
        \item file structure expected by POLSALT pre-reductions (often already complete)
        \item running \texttt{split}
