...
\begin{figure}
    ...
    \begin{subfigure}[b]{1.0\textwidth}
        ...
        \label{fig:trans_E}
    \end{subfigure}
    \caption{Examples of a well- and poor fit wavelength solution applied to the $O$- (\subref{fig:trans_O}) and $E$-beams (\subref{fig:trans_E}) of an arc image. The figures were scaled to best capture any deviation of the arc lines. Figures created by the \iraf\ \texttt{transform} task.}
