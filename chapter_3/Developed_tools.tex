...
\todo{Include screenshot of GUI, reference in paragraph}
...
\todo{From appendix → Discuss - all <\dots> params, - salt/py3 env, replace verbatim with listings for consistency, add polsalt GUI spectra extract, add polsalt GUI visualisation}
