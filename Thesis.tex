...
\hypersetup{%
    ...
    pdfsubject={%
        POLSALT alternate wavelength calibrations, created via IRAF and Python; parsing and validation handled via STOPS.
    },
    pdfkeywords={%
        STOPS,
...
\lstset{%
    ...
    inputpath=/media/justin/Transcend/STOPS/, % G:/STOPS/ (Windows)
}
...
\degreedate{Date of submission: \today} % MARK: TODO: Change \today to MONTH, YEAR at final submission
