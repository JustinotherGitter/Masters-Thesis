%\documentclass[a4paper,10pt, aas_macros]{report}
...
\usepackage[small]{caption}  %makes the captions to figures and tables slightly smaller than the normal text
%Math packages
...
% Add any wanted acronyms below
\newacronym{ADC}{ADC}{Analog-to-Digital Converter}
% \newacronym{Ar}{Ar}{Argon}
...
% \newacronym{NeAr}{NeAr}{Neon-Argon}
...
\usepackage[round,colon,authoryear,sort&compress]{natbib} %Sets bibliography references
\usepackage[nottoc]{tocbibind} % Adds bibliography to ToC
\usepackage{journal_macros} % Set macros for NASA ADS journal abbrevations
...
\usepackage{blindtext} % Allows for Lorem Ipsum text
% \usepackage{dirtree}
%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% \printglossary[type=abbreviations, style=alttree, title={List of Acronyms}]


\bibliographystyle{plainnat} % aasjournal (surnames first), humannat
%\bibliography{References/Catalogues,References/References}
