...
\begin{abstract}
    ...
    % Spectropolarimetry
    This, along with its wide wavelength coverage and dynamic queue scheduling, make the \gls{SALT}/\gls{RSS} ideal for spectropolarimetric observations of high-energy sources.
    %
    % AGN
    ...
    Furthermore, wavelength solutions for the complementary $O$- and $E$-beams may seemingly be well calibrated independently, but may not be consistent with each other. Consistent solutions across polarization beams are essential for correctly measuring the polarization.
    ...
    To improve the efficiency of \gls{SALT}/\gls{RSS} spectropolarimetric data reductions, and to ensure consistent wavelength solutions across the $O$- and $E$- beams, this study presents supplementary tools, as well as their development and testing.
