...
\begin{abstract}
    ...
    % Spectropolarimetry
    This, along with its wide wavelength coverage and high throughput, make the \gls{SALT}/\gls{RSS} ideal for spectropolarimetric observations of high-energy sources.
    %
    % AGN
    ...
    Furthermore, wavelength solutions for the complementary $O$- and $E$-beams may seemingly be well calibrated independently, but may not be consistent with each other. Consistent solutions are essential for correctly measuring the polarization.
    ...
    To improve the efficiency of reducing the SALT spectropolarimetry data and to ensure consistent wavelength calibration across the $O$ and $E$ beams, this study presented the develope and testing so supplementary tools which were developed. 
    % as part of this study to improve the efficiency and accuracy of spectropolarimetric data reductions.
    The software, named \stops, addresses limitations in the existing wavelength calibration method, allowing for external wavelength calibrations, such as those provided by \iraf, while also providing tools to verify the consistency of the wavelength solutions epoch-to-epoch or across polarimetric beams.
    % Testing
    Rigorous testing, through both synthetic and real data, has been conducted to ensure the reliability and accuracy of \stops.
    %
    % 3C 279
    The blazar 3C~279 was observed during periods of enhanced activity, 28 March and 17 May 2017, and of flaring, 31 March 2017.
    ...
    The degree of polarization for 3C~279 was found to be $\Pi \approx 13.3 \%$, and $21.1 \%$ for the epochs of enhanced activity, and $8.7 \%$ for the epoch of flaring, respectively.
    The degree of polarization shows good agreement across grating angles and remains fairly constant across the observed wavelength range while still displaying variability according to the transient nature of the blazar.
    The polarization angle of 3C~279, was found to be $\theta \approx 53.3$\degree, and $77.7$\degree\ for the epochs of enhanced activity, and $63.3$\degree\ for the epoch of flaring, respectively.
    The polarization angle shows a consistent angle across the observed wavelength range, with a slight deviation in the epoch of flaring.
    % Hiltner 652
    Furthermore, the spectrophotometric standard, Hiltner~652, was observed with the \gls{SALT}/\gls{RSS} in linear spectropolarimetry mode on 10 June 2022.
