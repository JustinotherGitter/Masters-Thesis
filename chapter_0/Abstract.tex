...
\begin{abstract}
    ...
    This provides better constraints to model the \gls{SED}, allowing a deeper understanding of the mechanisms and structures powering such highly energetic sources.
    %
    % polsalt
    ...
    To improve the time-efficiency of \gls{SALT}/\gls{RSS} spectropolarimetric data reductions, and to ensure consistent wavelength solutions across the $O$- and $E$-beams, this study presents \stops, as well as its development and testing.
    ...
    The degree of polarization for 3C~279 was found to be $\Pi \approx 13.3 \%$, and $21.1 \%$ during epochs of enhanced activity, and $8.7 \%$ during flaring, respectively.
    ...
    The polarization angle was found to be $\theta \approx 53.3$\degree, and $77.7$\degree\ during epochs of enhanced activity, and $63.3$\degree\ during flaring, respectively.
    The polarization angle remains consistent across the observed wavelength range, with a slight deviation between grating angles during flaring.
    % Hiltner 652
