...
\subsection[Verifying the \texttt{correlate} Method]{Cross Correlation Checks} \label{subsec:test_corr}
...
% MARK: WAV Sky. Checks
\subsection[Veryfing the \texttt{skylines} Method]{Sky Line Checks} \label{subsec:test_sky}
