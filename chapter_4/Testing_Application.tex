...
This shows that on the dates of the optical observations, 3C~$279$ was between $\sim4$ to $\sim8$ times brighter compared to its quiescent state. 
...
The linear polarization percentages and polarization angles also show variation over the course of the observations, varying between $\sim 12.23\%$ and $\sim 24.22$\degree.
