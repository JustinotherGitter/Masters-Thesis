...
As discussed in \cite[][see also \autoref{app:papers}]{cooper_HEASA2021}, the \stops\ pipeline was used during the reduction of the blazar $3$C~$279$, showcasing alternate wavelength calibrations applied to \gls{SALT} spectropolarimetric data.
