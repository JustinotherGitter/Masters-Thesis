...
The \gls{SALT} spectropolarimetric observations were reduced using a modified version of the pure \polsalt\ pipeline, modified to allow for the relative flux calibration of the spectra using a white dwarf, EGGR~$21$.

% \begin{figure}[t]
%     \centering
%     \includegraphics[width = 1.0\textwidth]{'4_grb191221_abs.pdf'}
%     \caption{caption. Figure adapted from \citep{Buckley191221B}.}
%     \label{fig:grb_abs}
% \end{figure}

% \todo{Include table of identified features and properties.}
