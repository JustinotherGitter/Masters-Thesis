...
\begin{figure}[t]
    ...
    \caption{The reduced $Q$ and $U$ Stokes parameters for Hiltner~$652$, pre$-2006$ for \glsxtrshort{FORS1}, $2010 - 2016$ for \glsxtrshort{FORS2}, and post$-2022$ for \gls{SALT}. Figure sourced from \citep{cooper_HEASA2022}.}
    \label{fig:Hilt652}
\end{figure}
